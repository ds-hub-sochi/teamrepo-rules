...
## Установка навыка и подключение

Устанавливайте навык по ссылке: [reuse-mesh](https://github.com/ds-hub-sochi/teamrepo-rules/tree/main/reuse-mesh). Он задаст только два вопроса: область настройки (проект или пользователь) и имя переменной окружения с ключом. Затем применит нативный способ выбранной IDE.
